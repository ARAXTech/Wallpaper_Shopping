...
public class CurvedBottomNavigationView extends BottomNavigationView {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        Log.d("height:",String.valueOf(mNavigationBarHeight));
        Log.d("width:",String.valueOf(mNavigationBarWidth));
        ...
        //Log.d("FirstCurveControlPoint1",String.valueOf(mFirstCurveControlPoint1));
